...
![systrace](http://developer.android.com/images/systrace/overview.png)
...
--app=<*APP_NAME*>`
Enable tracing for applications, specified as a comma-separated list of [package names](http://developer.android.com/guide/topics/manifest/manifest-element.html#package). The apps must contain tracing instrumentation calls from the `[Trace](http://developer.android.com/reference/android/os/Trace.html)`class. For more information, see [Analyzing UI Performance with Systrace](http://developer.android.com/tools/debugging/systrace.html#app-trace).
...
Conduct the trace on a specific connected device, identified by its [device serial number](http://developer.android.com/tools/help/adb.html#devicestatus).

#### 這種官網就可以查到的東西，我就不多加介紹了

2. 如果有command 恐懼症的人可以考慮使用圖形界面版

![no_root](../../assets/images/no_root.png)

[https://boochlin.com/wp-content/uploads/2015/07/no_root.png](https://boochlin.com/wp-content/uploads/2015/07/no_root.png)

![root](../../assets/images/root.png)

[https://boochlin.com/wp-content/uploads/2015/07/root.png](https://boochlin.com/wp-content/uploads/2015/07/root.png)
...
另外要注意的是 systrace 是建立再linux 的 [ftrace](https://www.kernel.org/doc/Documentation/trace/ftrace.txt)機制，所以device不啟用這相關module 的話
...
![all_1](../../assets/images/all_1.png)

[https://boochlin.com/wp-content/uploads/2015/07/all_1.png](https://boochlin.com/wp-content/uploads/2015/07/all_1.png)

dispatcher , surfaceflinger , event control (每一個關鍵component想要了解的話，應該可以再老羅的blog找到)

![all_2](../../assets/images/all_2.png)

[https://boochlin.com/wp-content/uploads/2015/07/all_2.png](https://boochlin.com/wp-content/uploads/2015/07/all_2.png)

allocation , fragment 配置，以及 android launcher的view週期

![all_4](../../assets/images/all_4.png)

[https://boochlin.com/wp-content/uploads/2015/07/all_4.png](https://boochlin.com/wp-content/uploads/2015/07/all_4.png)
...
![all_5](../../assets/images/all_5.png)

[https://boochlin.com/wp-content/uploads/2015/07/all_5.png](https://boochlin.com/wp-content/uploads/2015/07/all_5.png)
...
![unnormal](../../assets/images/unnormal.jpg)
...
![systrace_disk_busy](../../assets/images/systrace_disk_busy.png)

[https://boochlin.com/wp-content/uploads/2015/07/systrace_disk_busy.png](https://boochlin.com/wp-content/uploads/2015/07/systrace_disk_busy.png)
...
[http://my.oschina.net/innost/blog/135174](http://my.oschina.net/innost/blog/135174)

[http://www.cnblogs.com/tianzhijiexian/p/4264794.html](http://www.cnblogs.com/tianzhijiexian/p/4264794.html)
