...
## 二、 現代前端：Jetpack Compose 渲染機制與效能調校
...
## 五、 系統底層：Android Framework 原理與原始碼探秘
...
* [產品與工程哲學：約爾趣談軟體（Joel on Software）經典研讀筆記](posts/section10_philosophy/04_約爾趣談軟體筆記.md)
